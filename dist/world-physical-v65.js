...
function v65Show(context){
 ...
 $('#match-area .match-meta span:last-child').textContent=competition.type==='league'?'LIGASPIEL':competition.type==='cup'?'POKALSPIEL':`EUROPACUP${round?` · Spieltag ${round[1]}`:''}`;
