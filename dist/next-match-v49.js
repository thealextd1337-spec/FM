...
v49Style.textContent+=`.v49-side{display:block;margin-bottom:5px;color:#a9beb6;font-size:10px;font-weight:800;letter-spacing:.8px;text-transform:uppercase}.v49-club>strong{display:flex;align-items:center;gap:6px}.v49-club>strong>.flag-icon{width:20px;height:14px}.v49-club>strong>span{min-width:0}.v49-fixture>span{padding-top:20px}.center-lead>.squad-warnings h2{font:800 17px/1.2 Inter,Arial,sans-serif}@media(max-width:420px){.v49-club>strong{gap:4px}.v49-club>strong>.flag-icon{width:17px;height:12px}}`;
v49Style.textContent+=`.v49-fixture{align-items:stretch}.v49-club{display:flex;flex-direction:column}.v49-form{margin-top:auto;padding-top:8px}@media(max-width:760px){.v49-fixture{gap:6px}.v49-form{display:grid;width:100%;max-width:155px;grid-template-columns:repeat(5,minmax(0,1fr));gap:2px}.v49-form b{width:auto;min-width:0;height:24px}}@media(max-width:420px){.v49-form b{height:22px;font-size:10px}}@media(max-width:360px){.v49-club>strong{gap:3px;font-size:12px}.v49-club>strong>.flag-icon{width:15px;height:11px}}`;
...
function v49PreviewHTML(){
 ...
 return`<div class="v49-match-preview"><div class="v49-fixture"><div class="v49-club"><span class="v49-side">Heim</span><strong>${flagSVG('AT')}<span>${club(fixture.home)}</span></strong>${v49FormHTML(fixture.home)}</div><span>gegen</span><div class="v49-club"><span class="v49-side">Auswärts</span><strong>${flagSVG('AT')}<span>${club(fixture.away)}</span></strong>${v49FormHTML(fixture.away)}</div></div></div>`;
}
