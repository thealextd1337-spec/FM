...
v24Style.textContent+=`.cell[draggable=true],.bench-chip[draggable=true]{touch-action:pan-y}`;
...
function v24SelectedCompact(){
 ...
 if(heading)heading.textContent='Aufstellung';if(count)count.textContent='5 Feldspieler + Torwart';if(help)help.textContent='Spieler antippen und Zielfeld wählen. Zum Ziehen waagrecht starten.';
