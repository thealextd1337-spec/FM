...
- `node work/test-v53.cjs` prüft die interne 0–20-Skala, fünf Farbbereiche, die Ablehnung alter Spielstände und eine Karriere unmittelbar vor dem Pokalfinale. Der Test erzeugt `outputs/pokalfinale-staerke-0-20.json` zum Import in das Spiel.
